        ...
        <div class="bg-white p-6 rounded-lg shadow-lg w-96 h-screen overflow-auto">
            ...
            <form @submit.prevent="save">
                ...
                <div class="mb-4">
                    ...
                    <input v-model="date.patient_name" type="text" disabled
                        class="mt-1 p-2 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <p class="mt-1 p-2 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">{{ date.reserved?'yes':'no' }}</p>
                </div>
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700">Reason</label>
                    <input v-model="date.reason" type="text" disabled
                        class="mt-1 p-2 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                </div>
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700">Identity</label>
                    <input v-model="date.cnp" type="text" disabled
                        class="mt-1 p-2 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                </div>
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700">Birthdate</label>
                    <input v-model="date.birthdate" type="text" disabled
                        class="mt-1 p-2 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                </div>
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700">Phone</label>
                    <input v-model="date.phone" type="text" disabled
                        class="mt-1 p-2 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                </div>
            ...
            <div v-if="mode === 'delete'">
                ...
                <div class="flex justify-end">
                    <button @click="cancelDate"
                        class="mr-2 bg-red-500 text-white px-4 py-2 rounded-md hover:bg-red-600">Yes</button>
                    <button @click="close"
                        class="bg-gray-500 text-white px-4 py-2 rounded-md hover:bg-gray-600">No</button>
                </div>
            </div>
        </div>
    </div>
